...
class AddStudent implements ActionListener{
    ...
    public AddStudent(){
        ...
        id15.setLayout(null);
       // ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("university/management/system/icons/SI.jpg"));
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        String bb = t2.getText();//father's name
        String c = t3.getText();//age
        String d = t4.getText();//DOB
        String e = t5.getText();//address
        String ff = t6.getText();//phone no
        String g = t7.getText();//email id
        String h = t8.getText();//ssc gpa
        String i = t9.getText();//hsc gpa
        String j = t10.getText();//nationality
        String k = t11.getText();//roll no
        String l = (String)c1.getSelectedItem();//course 
