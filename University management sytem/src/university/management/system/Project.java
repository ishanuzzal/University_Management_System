...
public class Project extends JFrame implements ActionListener{
    Project(){
        ...
        ImageIcon ic =  new ImageIcon(ClassLoader.getSystemResource("university/management/system/icons/DP.jpg"));
        Image i3 = ic.getImage().getScaledInstance(1900, 1030,Image.SCALE_DEFAULT);
    ...
    public void actionPerformed(ActionEvent ae){
        //getActionCommand return menu name in string
