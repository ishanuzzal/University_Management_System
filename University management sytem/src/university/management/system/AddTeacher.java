...
class AddTeacher implements ActionListener{
	...
	lab.setFont(new Font("serif",Font.BOLD,20));
        ...
        String course[] = {"Information & Tecnology","Business & Adminastration","Law faculty","Science & Engineering"};
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        String a = t1.getText();//firstname
        String c = t2.getText();//last name
        String bb = t3.getText();//age
        String d = t4.getText();//dob
        String e = t5.getText();//address
        String ff = t6.getText();//Phone
        String g = t7.getText();//Email
        String h = t8.getText();//Designation
        String i = t9.getText();//blood group
        String j = t10.getText();//nid number
        String k = (String)c1.getSelectedItem();//faculty
        String l = t11.getText();//emp_id
        String m = (String)c2.getSelectedItem();//department
        
        if(ae.getSource() == b){
            try{
                conn cc = new conn();
                String q = "insert into teacher values('"+a+"','"+c+"','"+bb+"','"+d+"','"+e+"','"+ff+"','"+g+"','"+h+"','"+i+"','"+j+"','"+l+"','"+k+"','"+m+"')";
