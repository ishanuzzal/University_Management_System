...
public class StudentDetails extends JFrame implements ActionListener{
    ...
    JButton b1,b2,b3;
    JTextField t2;
    String x[] = {"name","father's name","Age","DateOfBirth(dd/mm/yy)","Address","Phone No.","Email","SSS GPA", "HSC GPA", "Nationality","Roll No","Course","Branch"}; 
    ...
    StudentDetails(){
        ...
        try{
            ...
            while(rs.next()){
                ...
                y[i][j++]=rs.getString("SSC_GPA");
                y[i][j++]=rs.getString("HSC_GPA");
