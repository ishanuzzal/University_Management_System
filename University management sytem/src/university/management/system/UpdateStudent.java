  ...
  lab2.setFont(new Font("serif",Font.BOLD,20));
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==b){
            try{
                conn con = new conn();
                  String str = "update student SET Name='"+t1.getText()+"',Father_name='"+t2.getText()+"',Age='"+t3.getText()+"',DateOfBirth='"+t4.getText()+"',Address='"+t5.getText()+"',Phone_No='"+t6.getText()+"',Email='"+t7.getText()+"',SSC_GPA='"+t8.getText()+"',HSC_GPA='"+t9.getText()+"',Nationality='"+t10.getText()+"',Roll_No='"+t11.getText()+"',Course='"+t13.getText()+"',Branch='"+t14.getText()+"' where Roll_No='"+t12.getText()+"'";
