...
class UpdateTeacher implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==b){
            try{
                conn con = new conn();
                String str = "update teacher set first_name='"+t1.getText()+"',last_name='"+t2.getText()+"',Age='"+t3.getText()+"',DateOfBirth='"+t4.getText()+"',address='"+t5.getText()+"',phone='"+t6.getText()+"',email='"+t7.getText()+"',designation='"+t8.getText()+"',blood='"+t9.getText()+"',nid_no='"+t10.getText()+"', emp_id = '"+t11.getText()+"',faculty='"+t13.getText()+"',Department='"+t14.getText()+"' where emp_id='"+t12.getText()+"'";
